...
(*TODO - GET RID OF UNNECESSARY CLAUSES, TURN INTO DIMACS*)
...
let _ =  (line2grid "790304108000006000000080059030000497000000000217000030470010000000700000302609071" 0 0) in printgrid grid 0 0;;

let formula =  fill_case 0 0 (unique_mat 0 0 (define_mat 0 0 (valid_all_columns 0 (valid_all_lines 0 (valid_all_small_grids 0 0 []))))) ;;
let _ = printclause formula;;
